            ...
            >
              ...
              <div className="mb-4 mt-3">
                <h1
                  ...
                  style={{ background: "rgba(0, 86, 47, 0.9)" }}
                >
                  Did you exercise regularly ? if yes how often do you workout?
                </h1>
                <div
              ...
              {data.ans2 && (
                <div className="mb-4 mt-3">
                  <h1
                    ...
                    style={{ background: "rgba(0, 86, 47, 0.9)" }}
                  >
                    Are you suffering from lack of focus ?
                  </h1>
                  <div
                    className="w-full px-2 py-2 mb-4 text-white"
                    style={{
              ...
              {data.ans3 && (
                <div className="mb-4 mt-3">
                  <h1
                    ...
                    style={{ background: "rgba(0, 86, 47, 0.9)" }}
                  >
                    Are you suffering from asthma or any other diseases ? if yes describe the duration and medication in detail
                  </h1>
                  <div
                    className="w-full px-2 py-2 mb-4 text-white"
                    style={{
